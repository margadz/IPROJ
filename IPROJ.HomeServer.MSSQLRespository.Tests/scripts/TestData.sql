...
INSERT INTO [HomeServer].[dbo].[Devices] (Name, TypeOfReading, IsActive, Host, TypeOfDevice) VALUES ('Temperatura w pokoju', 3 ,1, 'Host', 1)
INSERT INTO [HomeServer].[dbo].[Devices] (Name, TypeOfReading, IsActive, Host, TypeOfDevice) VALUES ('Temperatura w kuchni', 3 ,1, 'Host', 1)
INSERT INTO [HomeServer].[dbo].[Devices] (Name, TypeOfReading, IsActive, Host, TypeOfDevice) VALUES ('Temperatura w sypialni', 3,1, 'Host', 1)
INSERT INTO [HomeServer].[dbo].[Devices] (Name, TypeOfReading, IsActive, Host, TypeOfDevice) VALUES ('Temperatura w korytarzu', 3, 0, 'Host', 1)

INSERT INTO [HomeServer].[dbo].[Devices] (DeviceId, Name, TypeOfReading, IsActive, Host, TypeOfDevice) VALUES ('D28B2B0C-831A-4027-9B6D-3894F5A7EB69', 'Energia elektryczna w pokoju', 1 ,1, 'Host', 2)
INSERT INTO [HomeServer].[dbo].[Devices] (Name, TypeOfReading, IsActive, Host, TypeOfDevice) VALUES ('Energia elektryczna w kuchni', 1 , 1, 'Host', 2)
INSERT INTO [HomeServer].[dbo].[Devices] (Name, TypeOfReading, IsActive, Host, TypeOfDevice) VALUES ('Energia elektryczna w sypialni', 1, 1, 'Host', 2)
