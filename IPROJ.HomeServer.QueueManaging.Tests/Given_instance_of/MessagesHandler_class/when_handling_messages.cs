...
namespace Given_instance_of.MessagesHandler_class
{
    ...
    public class when_handling_messages
    {
        ...
        public void TheTest()
        {
            ...
            _queueListener.Raise(_ => _.OnMessegeReceived += null, _instantReadings.Concat(_dailyReadings).Concat(new DeviceReading[] { null, null }));
            Task.Delay(30).Wait();
        }
        ...
        public void ScenarioSetup()
        {
            ...
            _handler = new MessagesHandler(_dataRepository.Object, _queueListener.Object);
            TheTest();
        }
